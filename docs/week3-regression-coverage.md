...
| ID    | Status | Notes                                                                                                                                                                                                                                      |
| ----- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| W1-07 | PASS   | Static code review: explicit `Use friendly slug` action applies generated slug via shared handler and clears manual lock. Manual Block editor publish QA still pending.                                                                    |
